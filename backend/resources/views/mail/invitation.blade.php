...
<head>
    ...
    <title>Activez votre accès Ledge</title>
    <style>
...
<div class="wrapper">
    ...
    <div class="body">
        <p>Bonjour{{ $nom ? ' '.$nom : '' }},</p>
        <p class="message">
            Un accès à l'application Ledge vient d'être créé pour vous. Pour l'activer,
            définissez votre mot de passe personnel en cliquant sur le bouton ci-dessous.
        </p>

        <div class="cta-wrap">
            <a href="{{ $lien }}" class="cta">Définir mon mot de passe</a>
        </div>
